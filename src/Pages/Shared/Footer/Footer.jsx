      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 py-14">
        ...
        <div>
          ...
          <p className="text-sm mb-6">
            We are dedicated to helping you achieve your business goals and overcome any challenges that may arise.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a className="hover:text-white">Testimonials</a></li>
            <li><a className="hover:text-white">Projects</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a className="hover:text-white">Our Team</a></li>
