...
import aboutTick from '../../../assets/aboutTickMark.png'
import aboutExpert from '../../../assets/aboutExpertImg.png'
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 my-24 items-center '>
            ...
            <div>
                ...
                <p className='text-[#7A798B] mt-4'>We are specializes in helping companies accelerate their growth through expert guidance, strategic planning, and implementation support.</p>
                 <h1 className='flex gap-2 text-[#0D083A] mt-4'><span><img src={aboutTick} alt="" /></span> Performing market research</h1>
                 <h1 className='flex gap-2 mt-4 text-[#0D083A]'><span><img src={aboutTick} alt="" /></span> Performing market research</h1>
                 <h1 className='flex gap-2 mt-4 text-[#0D083A]'><span><img src={aboutTick} alt="" /></span> Performing market research</h1>
                 <div className='flex gap-4 mt-8'>
                    <img src={aboutExpert} alt="" />
