    ...
    return (
       <div className="bg-[#FEF5E4] py-21 px-46 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6">
            <div className='w-full'>
                <img className="pb-6" src="/assets/images/rwimg1 - Copy.png" alt="Wealth Management" />
            ...
            <div className='w-full'>
                <img className="pb-6" src="/assets/images/rwimg2.png" alt="Investment Planning" />
            ...
            <div className='w-full'>
                <img className="pb-6" src="/assets/images/rwimg3.png" alt="Retirement Solutions" />
