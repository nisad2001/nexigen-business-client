  ...
  return (
    <div>
      <div className='text-center mb-16 md:mb-32 px-4'>
        <p className='font-medium text-[16px] mb-4 uppercase text-[#D37302]'>
          how we works
        </p>
      ...
      <div className="relative bg-[#FEF5E4] pt-[120px] pb-20 px-4 md:px-0">
        ...
        {/* ====== FIRST CARD ====== */}
        <div
          className="bg-white shadow-[20px_40px_80px_0_rgba(0,0,0,0.1)] rounded-md w-full max-w-md md:w-[456px] h-auto md:h-[164px] mx-auto md:absolute md:top-[-80px] md:right-[500px] z-10 p-6 flex gap-6 items-center"
        ...
        <div className="mt-4 md:mt-2 flex flex-col md:flex-row justify-center gap-6 rounded-md max-w-full md:max-w-[960px] mx-auto">
          ...
          {/* ====== CARD TWO ====== */}
          <div className="bg-white shadow-[20px_40px_80px_0_rgba(0,0,0,0.1)] rounded-md w-full max-w-md md:w-[456px] h-auto md:h-[164px] p-6 flex gap-6 items-center">
            <div className="w-[56px] h-[61px] flex items-center justify-center bg-[#EFECFF] text-[#D37302] font-bold text-3xl py-4 px-[14px] rounded">
              02
            </div>
            <div>
          ...
          {/* ====== CARD THREE ====== */}
          <div className="bg-white shadow-[20px_40px_80px_0_rgba(0,0,0,0.1)] rounded-md w-[456px] h-[164px] md:w-[456px] h-auto md:h-[164px] p-6 flex gap-6 items-center">
            <div className="w-[56px] h-[61px] flex items-center justify-center bg-[#EFECFF] text-[#D37302] font-bold text-3xl py-4 px-[14px] rounded">
              03
            </div>
            <div>
